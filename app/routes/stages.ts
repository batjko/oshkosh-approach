...
export const stages = [
  {
    ...
    instructions: [
      { text: "Check current NOTAMs", icon: "check-circle" as IconName },
      { text: "Monitor ATIS on **125.9**", icon: "broadcast-tower" as IconName }, // Changed from "radio"
      { text: "Listen to Oshkosh ATIS", icon: "headphones" as IconName },
      { text: "Have AirVenture NOTAM on board", icon: "map" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Arrive at Ripon at **1,800** feet MSL", icon: "map-marker-alt" as IconName },
      { text: "Join single-file line over railroad tracks", icon: "users" as IconName },
      { text: "Form a single line following the tracks", icon: "route" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Maintain **90 knots** (or 2,300 rpm for slower aircraft)", icon: "tachometer-alt" as IconName },
      { text: "Maintain **1,800 feet** MSL", icon: "tachometer-alt" as IconName }, // Changed from "altimeter"
      { text: "Maintain half-mile separation", icon: "ruler" as IconName },
      { text: "Adjust spacing as instructed by ATC", icon: "broadcast-tower" as IconName }, // Changed from "radio"
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Follow **railroad tracks** from Ripon to Fisk", icon: "map" as IconName },
      { text: "Report at Fisk water tower", icon: "landmark" as IconName },
      { text: "Prepare for right turn at power plant", icon: "arrow-right" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Monitor Fisk Approach on **120.7**", icon: "broadcast-tower" as IconName }, // Changed from "radio"
      { text: "No radio calls until instructed", icon: "ban" as IconName },
      { text: "Acknowledge with wing rock only", icon: "plane" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Identify your aircraft type and color", icon: "plane" as IconName },
      { text: "Respond to ATC identification", icon: "reply" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Listen for runway assignment", icon: "broadcast-tower" as IconName },
      { text: "Prepare for last-minute changes", icon: "exclamation-triangle" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Turn right, follow the road", icon: "road" as IconName },
      { text: "Land on the colored dot ATC gives you", icon: "dot-circle" as IconName },
      { text: "**Await clearance** to land", icon: "check-circle" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Execute go-around if necessary", icon: "redo" as IconName },
      { text: "Fly runway heading, climb to **1,800 feet**", icon: "arrow-up" as IconName },
      { text: "Return to Ripon and start over", icon: "undo" as IconName },
    ],
  ...
  },
  {
    ...
    instructions: [
      { text: "Exit at next exit from colored dot", icon: "sign-out-alt" as IconName },
      { text: "Follow the flagman (Marshal)", icon: "flag" as IconName },
      { text: "Hold up identifier code page for Marshal", icon: "file-alt" as IconName },
      { text: "Taxi to GA parking as directed", icon: "parking" as IconName },
    ],
